...
void Analyzer::convertTextToRootFile(){
	...
	tree->Branch("DecayParticle2_mass",&DecayParticle2_mass);
	tree->Branch("DecayParticle2_isBoson",&DecayParticle2_isBoson);
	tree->Branch("DecayParticle2_px",&DecayParticle2_px);
	tree->Branch("DecayParticle2_py",&DecayParticle2_py);
	tree->Branch("DecayParticle2_pz",&DecayParticle2_pz);
	tree->Branch("DecayParticle2_E",&DecayParticle2_E);
	tree->Branch("DecayParticle2_TransMomentum",&DecayParticle2_TransMomentum);
